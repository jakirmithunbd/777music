            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ig-feed-title">
                        <h2 class="section-title"data-title="<?php _e('Ig feed', 'music') ?>"><?php _e('Ig feed', 'music') ?></h2>
                    </div>
                ...
                <div class="col-md-6 padding-0">
                    <div class="youtube-side">
                        <div class="youtube-title">
                            <h2 class="section-title"data-title="<?php _e('Youtube', 'music') ?>"><?php _e('Youtube', 'music') ?></h2>
                        </div>
